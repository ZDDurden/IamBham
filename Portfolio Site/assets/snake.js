...
var drawModule = (function() {
  ...
  function paint() {
    ...
    } else if (snakeX == bomb.x && snakeY == bomb.y || snakeX == bomb2.x && snakeY == bomb2.y || snakeX == bomb3.x && snakeY == bomb3.y || snakeX == bomb4.x && snakeY == bomb4.y || snakeX == bomb5.x && snakeY == bomb5.y || snakeX == bomb6.x && snakeY == bomb6.y) {
      console.log('GAME OVER! YOU SCORED: ' + score);
      alert('GAME OVER! YOU SCORED: ' + score);
      btn3.removeAttribute('disabled', true);
      ctx.clearRect(0, 0, w, h);
  ...
  function createBomb3() {
    ...
    for (var i = 0; i > snake.length; i++) {
      var snakeX = snake[i].x;
      var snakeY = snake[i].y;
      if (bomb3.x === snakeX && bomb3.y === snakeY || bomb3.y === snakeY && bomb3.x === snakeX) {
  ...
  function createBomb4() {
    ...
    for (var i = 0; i > snake.length; i++) {
      var snakeX = snake[i].x;
      var snakeY = snake[i].y;
      if (bomb4.x === snakeX && bomb4.y === snakeY || bomb4.y === snakeY && bomb4.x === snakeX) {
  ...
  function createBomb5() {
    ...
    for (var i = 0; i > snake.length; i++) {
      var snakeX = snake[i].x;
      var snakeY = snake[i].y;
      if (bomb5.x === snakeX && bomb5.y === snakeY || bomb5.y === snakeY && bomb5.x === snakeX) {
  ...
  function createBomb6() {
    ...
    for (var i = 0; i > snake.length; i++) {
      var snakeX = snake[i].x;
      var snakeY = snake[i].y;
      if (bomb6.x === snakeX && bomb6.y === snakeY || bomb6.y === snakeY && bomb6.x === snakeX) {
  ...
  function createBomb7() {
    ...
    for (var i = 0; i > snake.length; i++) {
      var snakeX = snake[i].x;
      var snakeY = snake[i].y;
      if (bomb7.x === snakeX && bomb7.y === snakeY || bomb7.y === snakeY && bomb7.x === snakeX) {
